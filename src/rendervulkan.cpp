...
static const uint32_t *renderer_get_shm_texture_formats( struct wlr_renderer 
*wlr_renderer, size_t *len )
{
...
static const struct wlr_renderer_impl renderer_impl = {.get_shm_texture_formats = renderer_get_shm_texture_formats,
